...
const AdminCoupnCard = ({ coupon }) => {
  ...
  return (
    <div className=" my-3 px-2 prod-container p-4">
      ...
      <Row className="d-flex justify-content-between  ">
        <Col xs="12" sm="6">
          <div className="p-2">
            اسم الكوبون: <p className="text-danger d-inline"> {coupon.name}</p>
          </div>
        </Col>
        <Col
          xs="12"
          sm="6"
          className="d-flex d-flex justify-content-sm-end justify-content-start"
        >
